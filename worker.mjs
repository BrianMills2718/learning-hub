...
try {
  ...
  const liveAgent = new LlmClientCurriculumAgent({ model: checkpoint ? continuationModel : generationModel, maxBudget: 1, task: "learning_hub_generation", traceIdPrefix: `learning-hub/${brief.id}`, pythonExecutable: python, environment: process.env, reasoningEffort: "none", maxRetries: 1, maxRevisionPasses: 2 });
